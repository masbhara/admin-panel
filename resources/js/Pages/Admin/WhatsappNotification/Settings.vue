        ...
        <div v-if="showAlert" :class="[
          ...
          <div class="flex">
            <div class="flex-shrink-0">
              <CheckCircleIcon v-if="alertType === 'success'" class="h-5 w-5 text-green-400" />
            ...
            <div class="ml-auto pl-3">
              <div class="-mx-1.5 -my-1.5">
                <button
                  ...
                  :class="[
                    alertType === 'success' ? 'bg-green-50 text-green-500 hover:bg-green-100' : 'bg-red-50 text-red-500 hover:bg-red-100'
                  ]"
                >
