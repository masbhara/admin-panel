<template>
  <AdminLayout title="Roles" :user="$page.props.auth?.user">
    <div class="py-6">
        ...
        <div class="bg-white dark:bg-primary-600 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white dark:bg-primary-600 border-b border-gray-200 dark:border-gray-700">
            <div class="flex justify-between items-center mb-6">
              <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Roles</h2>
                ...
                <tbody class="bg-white dark:bg-primary-600 divide-y divide-gray-200 dark:divide-gray-700">
                  <tr v-for="role in roles.data" :key="role.id">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      ...
                      <button
                        v-if="$page.props.can && $page.props.can.delete_roles && role.name !== 'super-admin' && role.users_count === 0"
...
const confirmDelete = () => {
  form.delete(route('admin.roles.destroy', selectedRole.value), {
    onSuccess: () => {
